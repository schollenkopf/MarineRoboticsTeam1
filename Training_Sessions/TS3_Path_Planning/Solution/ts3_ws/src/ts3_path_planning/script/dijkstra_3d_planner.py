...
class Dijkstra3DPathPlanner:
    ...
    def dijkstra(self):
        ...
        start_z = int(self.start.z)
        goal_x =  int(self.goal.x) 
        goal_y =  int(self.goal.y) 
        goal_z =  int(self.goal.z) 
        ...
        self.s_start = (start_x, start_y, start_z)
        self.s_goal = (goal_x, goal_y, goal_z)
        ...
        while self.OPEN:
            ...
            for s_n in self.get_neighbors(s[0], s[1], s[2]):
